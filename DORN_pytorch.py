...
class DORN_nyu(nn.Module):
    def __init__(self):
        ...
        self.conv3_1_3x3 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        # proj skip
        self.conv3_1_1x1_proj = nn.Conv2d(256, 512, kernel_size=1, stride=1, bias=False)
        ...
        self.conv4_20_3x3 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        # ASPP
        # Full Image Encoder
        self.reduce_pooling = nn.AvgPool2d(kernel_size=8, stride=8)
        ...
        # self.zoom_conv8 = Not sure what this is?
    ...
    def forward(self, x):
        ...
        x1 = self.conv2_1_1x1_increase_bn
        ...
        x1 = self.conv2_3_1x1_reduce_bn(x)
        x1 = self.conv2_3_1x1_reduce_relu(x)

        x1 = self.conv2_3_3x3(x)
        x1 = self.conv2_3_3x3_bn(x)
        ...
        x1 = self.conv4_3_1x1_reduce_relu(x)
        ...
        ### conv4_15
        x1 = self.conv4_15_1x1_reduce(x1)
        ...
        x1 = self.conv5_1_1x1_reduce_relu

        x1 = self.conv5_1_3x3(x1)
        x1 = self.conv5_1_3x3_bn(x1)
        x1 = self.conv5_1_3x3_relu
        ...
        x1 = self.relu6_1(x1)
        # self.interp_conv6_1 = # Do the expansion in the forward pass, to size H x W = 33 x 45
        x1 = x1.expand(-1, -1, 33, 45) # kind of arbitrary
        # End Full Image Encoder
